...
//#define   SDI_PIN    7    // SDI (serial mode) signal connected to pin 6
//#define   SCL_PIN    14    // SCL (serial mdoe) signal connected to pin 7
//#define    RS_PIN    10    // RS signal connected to pin 8
